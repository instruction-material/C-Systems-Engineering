# Unit 2: Binary, Hex, and Number Representation supplemental 2

Course: C Systems Engineering
Module: Unit 2: Binary, Hex, and Number Representation supplemental 2
...
Quick run hint: `cc main.c -o app && ./app`
